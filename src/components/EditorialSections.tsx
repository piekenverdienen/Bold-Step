        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <div className="prose prose-sm opacity-70 font-light leading-relaxed mb-12">
              <p>
                {lang === 'EN' 
                  ? "The proposal is the first bold step in your shared narrative. It requires a balance of nerves and sartorial confidence. Choosing the right setting is paramount, but so is your presence."
                  : "Der Antrag ist der erste mutige Schritt in Ihrer gemeinsamen Geschichte. Er erfordert ein Gleichgewicht zwischen Nerven und sartorialem Selbstvertrauen. Die Wahl des richtigen Rahmens ist entscheidend, ebenso wie Ihre Präsenz."}
              </p>
              <p className="mt-4">
                {lang === 'EN'
