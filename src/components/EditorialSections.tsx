        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <div className="p-8 border border-brand-black/5 bg-brand-champagne/10">
              ...
              <a 
                href="https://aurelien-online.com/collections/driving-shoes?utm_source=bold-step&utm_medium=referral&utm_campaign=editorial"
                target="_blank"
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4">
              <a 
                href="https://aurelien-online.com/collections/loafers?utm_source=bold-step&utm_medium=referral&utm_campaign=editorial"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a 
                href="https://aurelien-online.com/collections/city-loafers?utm_source=bold-step&utm_medium=referral&utm_campaign=editorial"
                target="_blank"
                rel="noopener noreferrer"
                className="p-6 bg-white border border-brand-black/5 hover:border-brand-gold transition-colors group"
              >
