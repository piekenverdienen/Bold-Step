...
Third, prepare what you want to say.
...
Fourth, consider your presentation.
...
Because in the end, a proposal isn’t about perfection.

It’s about taking the first bold step toward forever.`
        }
      ]
    }
  },
...
Der erste Schritt ist die Absicht.
...
Drittens: Bereiten Sie vor, was Sie sagen wollen.
...
Viertens: Achten Sie auf Ihre Präsentation.
...
Schließlich: Lassen Sie die Emotionen zu.
...
Denn am Ende geht es bei einem Antrag nicht um Perfektion.

Es geht darum, den ersten mutigen Schritt in Richtung Ewigkeit zu tun.`
        }
      ]
    }
  }
