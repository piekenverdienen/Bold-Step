...
const SUITS = [
  ...
  navy: {
    ...
    DE: [
      { name: 'Cognac', hex: '#8B5A2B', product: LOAFER_PRODUCTS.COGNAC, reason: 'Der Klassiker. Warmes Cognac zu kühlem Navy – funktioniert immer.', best: true },
      { name: 'Tan', hex: '#C4A777', product: LOAFER_PRODUCTS.TAN, reason: 'Die leichte, sommerliche Variante, die Navy frischer wirken lässt.' },
      { name: 'Dunkelbraun', hex: '#4A3222', product: LOAFER_PRODUCTS.DARK_BROWN, reason: 'Kräftig und ruhig. Die zurückhaltende Wahl für die Abendtrauung.' },
      { name: 'Burgunder', hex: '#6B2C3C', product: LOAFER_PRODUCTS.BURGUNDY, reason: 'Mutig und unerwartet. Für den Bräutigam mit Stilbewusstsein.' },
    ],
    NL: [
  ...
  grey: {
    ...
    DE: [
      { name: 'Cognac', hex: '#8B5A2B', product: LOAFER_PRODUCTS.COGNAC, reason: 'Der sichere Klassiker. Warm zu kühl, immer im Gleichgewicht.', best: true },
  ...
  forest: {
    ...
    DE: [
      { name: 'Cognac', hex: '#8B5A2B', product: LOAFER_PRODUCTS.COGNAC, reason: 'Die schönste Erdton-Kombination. Warm, ruhig, festlich.', best: true },
  ...
  brown: {
    ...
    DE: [
      { name: 'Cognac', hex: '#8B5A2B', product: LOAFER_PRODUCTS.COGNAC, reason: 'Ton-in-Ton-Spiel. Verwandt, aber unterschiedlich genug – sehr elegant.', best: true },
...
const STYLE_TIPS_DE: Record<string, string[]> = {
  navy: [
    'Cognac und Tan sind die erste Wahl zum Navy-Anzug. Eine Kombination, die immer funktioniert.',
    'Tipp: Gürtel und Schuhe in derselben Lederfarbe halten – das gibt dem Look Ruhe.',
    'Für die Abendtrauung dunklere Töne wählen: Dunkelbraun oder Burgunder.',
    'Füßlinge oder gemusterte Knöchel-Akzente machen den Look modern.',
  ],
  midnight: [
    'Mitternachtsblau ist eine Spur festlicher als Navy – halten Sie den Loafer entsprechend ruhig.',
    'Cognac passt weiterhin hervorragend, Dunkelbraun führt schon Richtung Black Tie.',
    'Ein Einstecktuch in der Wärme Ihres Schuhleders rundet den Look ab.',
  ],
  charcoal: [
    'Anthrazit ist erstaunlich vielseitig – fast jedes Braun funktioniert.',
    'Helle Loafer wirken hier oft fehl am Platz – mittlere bis dunkle Töne bewahren die Festlichkeit.',
    'Burgunder setzt einen ruhigen Farbakzent und passt ideal zu kreativen Bräutigamen.',
  ],
  black: [
    'Schwarzer Anzug, schwarze Schuhe – diese Regel hat ihren guten Grund.',
    'Bei einer weniger förmlichen Hochzeit dürfen es auch sehr dunkle Brauntöne sein.',
    'Lack- oder Hochglanzleder hebt den Look für die Abendfeier zusätzlich.',
  ],
  lightgrey: [
    'Zum hellgrauen Anzug gehören helle Schuhe – Tan, Sand oder Creme funktionieren am besten.',
    'Hellgrau ist meist ein Sommeranzug. Lassen Sie ihm seine Leichtigkeit.',
    'Schwere, dunkle Schuhe wirken hier deplatziert. Halten Sie es luftig.',
  ],
  grey: [
    'Mittelgrau ist das Chamäleon – es harmoniert mit fast jedem Loafer.',
    'Cognac ist die sicherste und eleganteste Wahl, zu jeder Tageszeit.',
    'Im Herbst lohnt sich Burgunder oder ein dunkleres Braun für die saisonale Note.',
  ],
  beige: [
    'Beige liebt Wärme. Schokolade, Cognac und Karamell sind die natürlichen Partner.',
    'Ein Wildleder-Loafer schafft schönen Texturkontrast zum glatten Anzugstoff.',
    'Schwarze Schuhe zu Beige? Lieber nicht – der Kontrast wirkt zu hart.',
  ],
  sand: [
    'Sandfarbene Anzüge sind von Natur aus entspannt – der Schuh darf das aufgreifen.',
    'Wildleder statt Glattleder – passt einfach besser zur Stoffstruktur.',
  ...
  tan: [
    ...
    'Dunkelbraun gibt mehr Kontrast, Creme hält den Look hell und leicht.',
    'Ideal für Hochzeiten am Tag und unter freiem Himmel.',
  ],
  cream: [
    'Creme ist empfindlich – halten Sie die Schuhfarbe ruhig und nah am Anzug.',
    'Dunkle Schuhe lieber vermeiden. Helle Brauntöne und Tan stehen besser.',
    'Wie gemacht für die Hochzeit am Strand. Genießen Sie die Leichtigkeit.',
  ],
  olive: [
    'Oliv und Tan – eine klassische Erdton-Kombination aus der italienischen Schneiderei.',
    'Wildleder-Loafer unterstreichen den natürlichen Charakter eines olivfarbenen Anzugs.',
    'Halten Sie die ganze Palette warm und ruhig – auf grelle Akzente verzichten.',
  ],
  forest: [
    'Waldgrün ist mutig – warmes, sattes Leder erdet die Farbe.',
    'Cognac und Dunkelbraun sind hier die besten Partner.',
    'Wie gemacht für Herbst- oder Waldhochzeiten mit erdigem Farbkonzept.',
  ],
  burgundy: [
    'Lassen Sie den Anzug die Hauptrolle spielen. Wählen Sie dezente Schuhfarben.',
    'Dunkelbraun ist der sicherste Begleiter – es ergänzt, ohne zu konkurrieren.',
    'Schuhe mit Rotstich vermeiden – sie kollidieren mit dem Anzugton.',
  ],
  lightblue: [
    'Hellblau und Tan – die klassische Kombination für die Sommerhochzeit.',
    'Halten Sie das Gesamtbild leicht – schwere Schuhe würden den Look erden.',
    'Ein geflochtener Leder-Loafer bringt Textur in den sommerlichen Look.',
  ],
  brown: [
    'Ton-in-Ton-Kunst. Bleiben Sie für Stimmigkeit in der braunen Farbfamilie.',
    'Ein hellerer Loafer setzt Kontrast, ein ähnlicher Ton lässt den Look fließen.',
    'Wildleder oder Nubuk passen wunderbar zu Anzügen aus Baumwolle oder Leinen.',
  ],
  white: [
    'Zum weißen Anzug gehören die hellsten, weichsten Schuhtöne.',
    'Creme, Nude oder helles Tan – nichts Schweres.',
    'Der klassische Look für die Hochzeit am Meer. Halten Sie ihn mühelos.',
  ],
};
...
export default function SuitMatcher({ lang }: SuitMatcherProps) {
  ...
  const t = {
    ...
    DE: {
      label: "Stilratgeber für die Hochzeit",
      title: "Der Anzug-Matcher",
      subtitle: "Wählen Sie Ihre Anzugfarbe – wir zeigen Ihnen den passenden Loafer dazu. Denn die Schuhe sollten immer dieselbe Sprache sprechen wie der Anzug.",
      choose: "Wählen Sie Ihren Anzug",
      chooseSub: "Klassische Farbe wählen oder unten den exakten Farbton bestimmen",
      custom: "Oder Ihren genauen Farbton wählen:",
      yourSuit: "Ihr Anzug",
      bestLoafer: "Unsere Empfehlung",
      recTitle: "Passende Loafer-Farben",
      recSub: `Die besten Kombinationen zu ${selectedSuit?.name[lang] || 'Ihrem Anzug'}`,
      tipsTitle: "Tipps zum Styling",
      shopNow: "Jetzt kaufen",
      viewCollection: "Kollektion ansehen",
      footer: "The Groom Code — Stilsicher an dem Tag, der zählt."
    },
    NL: {
